   ...
   */
		...
		(function batchInterpolate() {
			...
			while (x < bounds.width) {
				...
				if (Date.now() - start > 1000) {
					//MAX_TASK_TIME) {
					setTimeout(batchInterpolate, 10);
					return;
				}
			}
	...
	var animate = function animate(bounds, field) {
		...
		function windIntensityColorScale(step, maxWind) {
			...
			var result = ["rgb(0,1,254)","rgb(0,36,252)","rgb(0,73,243)","rgb(0,106,231)","rgb(0,140,212)","rgb(0,168,190)","rgb(0,194,163)","rgb(0,215,134)","rgb(0,233,101)","rgb(0,245,67)","rgb(0,252,30)","rgb(3,254,0)","rgb(40,251,0)","rgb(76,243,0)","rgb(110,228,0)","rgb(142,211,0)","rgb(171,188,0)","rgb(196,161,0)","rgb(217,131,0)","rgb(234,98,0)","rgb(246,64,0)","rgb(253,28,0)","rgb(254,0,7)","rgb(250,0,44)","rgb(241,0,79)","rgb(227,0,113)","rgb(208,0,145)","rgb(185,0,173)","rgb(181,5,181)","rgb(183,13,183)"];
